...
@section('aside')
     <aside class="h-full w-2/12 shrink-0 overflow-y-auto border border-gray-200 bg-white px-5 py-8">
            <nav class="flex h-full flex-col" aria-label="Navegación principal">
                ...
                <a href="#"
                    ...
                    <svg class="size-4 shrink-0 text-slate-400" viewBox="0 0 24 24" fill="none"
